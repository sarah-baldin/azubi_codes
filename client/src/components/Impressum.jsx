		...
		<NavBar />
			<section className="impressum">
				<div className="footer-link-content col-12">
					...
					<p className="credits">Dieses Impressum wurde freundlicherweise von <a href="www.jurarat.de">JuraRat</a> zur Verfügung gestellt.</p>
				</div>
			</section>
		</div>
	);
